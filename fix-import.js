...
const gamePlayContent = `import { useState, useEffect, useRef, useCallback } from 'react'
...
const fixedContent = gamePlayContent.replace(/\\\\\\\`/g, '\`');

fs.writeFileSync('C:/Users/Somto/Documents/geo-elevate/frontend/src/pages/GamePlay.jsx', fixedContent);
console.log('Updated GamePlay.jsx');
